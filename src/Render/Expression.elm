...
verbatimElement settings formatList meta str =
    Element.el (Font.size (Render.Settings.scaleFont settings 18) :: htmlId meta.id :: Element.height Element.shrink :: Background.color settings.codeBackground :: formatList) (Element.text str)
